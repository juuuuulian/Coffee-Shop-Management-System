...
public class MainWin extends JFrame {
    ...
    public MainWin(String title) {
        ...
        JMenuItem mEditProduct = new JMenuItem("Product");
        JMenu mReport = new JMenu("Reports");
        JMenuItem mReportPL = new JMenuItem("P&L");
        ...
        mEdit.add(mEditProduct);
        mReport.add(mReportPL);
        mHelp.add(mAbout);
        ...
        JButton bNew = new JButton(new ImageIcon(Objects.requireNonNull(getClass().getResource("resources/file_new.png"))));
        ...
        JButton bOpen = new JButton(new ImageIcon(Objects.requireNonNull(getClass().getResource("resources/file_open.png"))));
        bOpen.setActionCommand("Open JADE file");
        bOpen.setToolTipText("Open JADE file");
        toolbar.add(bOpen);
        bOpen.addActionListener(event -> onOpenClick());

        JButton bSave = new JButton(new ImageIcon(Objects.requireNonNull(getClass().getResource("resources/file_save.png"))));
        bSave.setActionCommand("Save JADE file");
        bSave.setToolTipText("Save JADE file");
        toolbar.add(bSave);
        bSave.addActionListener(event -> onSaveClick());

        JButton bSaveAs = new JButton(new ImageIcon(Objects.requireNonNull(getClass().getResource("resources/file_save_as.png"))));
        ...
        bOrder = new JButton(new ImageIcon(Objects.requireNonNull(getClass().getResource("resources/new_order.png"))));
        ...
        bJava = new JButton(new ImageIcon(Objects.requireNonNull(getClass().getResource("resources/new_java.png"))));
        ...
        bDonut = new JButton(new ImageIcon(Objects.requireNonNull(getClass().getResource("resources/new_donut.png"))));
        ...
        bCustomer = new JButton(new ImageIcon(Objects.requireNonNull(getClass().getResource("resources/new_customer.png"))));
        ...
        bServer = new JButton(new ImageIcon(Objects.requireNonNull(getClass().getResource("resources/new_server.png"))));
        ...
        bListOrders = new JButton(new ImageIcon(Objects.requireNonNull(getClass().getResource("resources/list_orders.png"))));
        ...
        //Icon pic1 = new ImageIcon(Objects.requireNonNull(getClass().getResource("pics/cof1.png")));
        //Icon pic2 = new ImageIcon(Objects.requireNonNull(getClass().getResource("pics/donut1.png")));

        bListProducts = new JButton(new ImageIcon(Objects.requireNonNull(getClass().getResource("resources/list_products.png"))));
        ...
        bListPeople = new JButton(new ImageIcon(Objects.requireNonNull(getClass().getResource("resources/list_people.png"))));
        ...
        JButton bEdit = new JButton("Edit Product");
        bEdit.setActionCommand("Edit Product");
        bEdit.setToolTipText("Edit Product");
        toolbar.add(bEdit);
        //bEdit.addActionListener(event -> updateDisplay(Display.PEOPLE));

        JButton bReportPL = new JButton("Profit/Loss");
        bReportPL.setActionCommand("Profit/Loss");
        bReportPL.setToolTipText("Profit/Loss");
        toolbar.add(bReportPL);
        //bEdit.addActionListener(event -> updateDisplay(Display.PEOPLE));

        JButton bAbout = new JButton(new ImageIcon(Objects.requireNonNull(getClass().getResource("resources/about.png"))));
